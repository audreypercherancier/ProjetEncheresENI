...
<c:if test="${empty userConnected}">
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
		<div class="container-fluid">
			<a class="navbar-brand" href="/ProjetEncheresENI/index.jsp">ProjetEnchereEni</a>
			...
			<div class="collapse navbar-collapse" id="navbarColor01">
				<ul class="navbar-nav me-auto">
					<li class="nav-item"><a class="nav-link active" href="#">Encheres
			...
			<ul class="navbar-nav me-auto list-inline">
				<div id="navbarColor01">
					<li class="nav-item list-inline-item me-5 ms-1"><a
						class="nav-link active" href="#">Encheres</a></li>
					<li class="nav-item list-inline-item"><a class="nav-link"
						href="#">Vendre un article</a></li>
				</div>
			</ul>
			<button class="navbar-toggler" type="button"
				...
				<div class="offcanvas-body">
					<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="#">Mon profil</a></li>
						<li class="nav-item">
