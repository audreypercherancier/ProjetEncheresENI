...
<body>
	...
	<form action="<%=request.getContextPath()%>/enchereEffectuee"
		...
		<br /> <label for="categorie">categorie : </label> <input type="text"
			id="categorie" value="${article.getCategorie().getLibelle()}">
		<br /> <label for="meilleureEnchere">Meilleure offre :</label> <input
			type="text" value="${article.getPrixVente() }" id="meilleureEnchere">
		<br /> <label for="prixDepart">Mise à prix : </label> <input
			type="text" value="${article.getMiseAPrix() }" id="prixDepart">
		<br /> <label for="fin">Fin de l'enchère : </label> <input type="text"
		...
		<input type="text"
			...
			id="retrait"> <br /> <label for="vendeur">Vendeur :
		</label> <input type="text" value="${article.pseudo }" id="vendeur"> <br />
		<label for="monEnchere">Ma proposition : </label> <input type="number"
			value="${article.getPrixVente() }" id="monEnchere"> <br /> <input
			type="submit" class="btn btn-secondary" value="Enchérir">
	</form>
